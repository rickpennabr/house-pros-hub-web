...
interface AngiIconProps {
  className?: string;
}

/**
 * Angi icon (vector) as a React component.
 * Uses `currentColor` so it matches surrounding icon color.
 */
export function AngiIcon({ className }: AngiIconProps) {
  return (
    <svg
      className={className}
      viewBox="0 0 560 400"
