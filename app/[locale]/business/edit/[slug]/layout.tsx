...
interface EditBusinessLayoutProps {
  children: ReactNode;
}

export default function EditBusinessLayout({ children }: EditBusinessLayoutProps) {
        ...
        <header className="w-full h-[60px] border-b-2 border-black p-2 md:px-2 md:py-4">
          <div className="relative w-full h-full flex items-center">
            ...
            <div className="flex items-center flex-shrink-0 z-10">
              <Link
                href={`/${locale}/account-management`}
                ...
                aria-label="Go to account management"
              >
                <Image
