...
export default function BusinessList() {
  ...
  // Ensure saved view is valid ViewType
  ...
  // Show pagination only if there are 2 or more pages
  const shouldShowPagination = totalPages >= 2;

  // Get base URL for structured data (static for SSR compatibility)
  ...
  return (
    <>
      <div className={`w-full min-h-full flex flex-col ${isAtBottom && !isMobile && !isLoading && filteredCards.length > 0 ? 'pb-[140px]' : ''}`}>
        {isLoading ? (
