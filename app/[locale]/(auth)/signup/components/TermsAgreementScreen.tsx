...
export function TermsAgreementScreen({
  ...
  const t = useTranslations('auth.signup.termsAgreement');
  ...
  return (
    <div className="w-full max-w-md mx-auto flex flex-col text-black md:pt-12">
      ...
      {/* Title */}
      <div className="flex items-center justify-center gap-3 mb-2 pt-4">
      ...
      <div className="mb-6">
        <label className="flex items-start cursor-pointer">
          <input
            ...
            className="w-4 h-4 mt-0.5 border-2 border-black rounded accent-black checked:bg-black checked:border-black flex-shrink-0"
