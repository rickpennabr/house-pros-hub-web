export const metadata = {
  title: 'Privacy Policy | House Pros Hub',
  description: 'Privacy Policy for House Pros Hub marketplace platform',
};
      ...
      <div className="bg-white p-6 md:p-8">
          ...
          <div className="prose prose-sm max-w-none text-gray-800 space-y-6">
            <section>
              ...
              <p>
                House Pros Hub ("we", "us", or "our") is committed to protecting your privacy. This Privacy Policy explains how we collect, use, disclose, and safeguard your information when you use our marketplace platform that connects customers with contractors and service providers.
              </p>
              <p className="mt-4">
            ...
            <section>
              ...
              <p className="mt-4">
                For more detailed information about our use of cookies, please see our <a href="/legal/cookies" target="_blank" rel="noopener noreferrer" className="underline hover:text-black">Cookie Policy</a>.
              </p>
            </section>
            ...
            <section>
              <h2 className="text-2xl font-bold text-black mt-8 mb-4">9. Data Retention</h2>
              <p>
            ...
            <section>
              <h2 className="text-2xl font-bold text-black mt-8 mb-4">10. International Users</h2>
              <p>
            ...
            <section>
              <h2 className="text-2xl font-bold text-black mt-8 mb-4">11. California Privacy Rights</h2>
              <p>
            ...
            <section>
              <h2 className="text-2xl font-bold text-black mt-8 mb-4">12. Changes to This Privacy Policy</h2>
              <p>
